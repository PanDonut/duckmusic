                ...
                if(item.link == path){
                    return (
                        <div key={item.title} onLoad={() => {
							...
							setPlaylistIndex(SONGS.indexOf(item))
						}}>
							{size.width < CONST.MOBILE_SIZE &&
				 ...
				 M244.95,310.2c-36,0-65.3-29.3-65.3-65.3s29.3-65.3,65.3-65.3s65.3,29.3,65.3,65.3S280.95,310.2,244.95,310.2z"/>
							...
							<div className={styles.playlistDetails} onClick={() => { document.documentElement.style.setProperty('--dispopen', 'none') }}>
								...
								<div className={styles.imgBox2}>
									<img src={item.imgUrl} className={styles.imgBox1} />
									</div>
							...
							<div className={styles.GridIcons}>
								{size.width > CONST.MOBILE_SIZE &&
									<div className={styles.PlaylistIcons}>
										...
										<button
											onClick={() => props.changeTrack([SONGS.indexOf(item), 0])}
										>
								...
								{size.width < CONST.MOBILE_SIZE &&
									<button onClick={() => props.changeTrack([SONGS.indexOf(item), 0])}>
										Słuchaj
									</button>
								}
							</div>
