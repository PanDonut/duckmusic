...
ARTYŚCI</h3>
          <h3 onClick={() => {history.push("/library/songs/favourites")}} style={{color: `${window.location.pathname.includes("/library/songs/favourites") ? 'var(--akcent)' : 'var(--text-gray)'}`}}><svg style={{fill: `${window.location.pathname.includes("/library/songs") ? 'var(--akcent)' : 'var(--text-gray)'}`}} width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
